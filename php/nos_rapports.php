...
<html>
	<head>
		<title> Nos rapports | EntraiDucation association humanitaire pour l'accès à l'éducation </title>
		<meta charset="utf-8" />
		<meta name="description" content="Découvrez les rapports d'EntraiDucation !" />
	...
	<body id="rapports">
		...
		<main>
			<section id="articles">
				...
				<h1> Les rapports d'activités pour l'accès à l'éducation </h1>
						...
						$query2 = "select *
							...
							if ($q2)
							{
								while ($row2 = mysql_fetch_assoc($q2))
								{
									...
									echo substr($row2['post_content'], 0, 130) . '...</p>';
